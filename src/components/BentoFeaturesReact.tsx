  ...
  return (
    <BentoGrid className="max-w-7xl mx-auto">
      ...
      <BentoGridItem
        ...
        className="md:col-span-2 transition-colors duration-200 bg-[#121215] border border-[#27272a] hover:border-purple-500 hover:bg-[#18181b]"
        header={
      ...
      <BentoGridItem
        ...
        className="md:col-span-1 transition-colors duration-200 bg-[#121215] border border-[#27272a] hover:border-purple-500 hover:bg-[#18181b]"
        header={
      ...
      <BentoGridItem
        ...
        header={
          <div className="flex flex-1 w-full h-32 rounded-xl bg-[#18181b] border border-[#27272a] items-center justify-center">
            <div className="w-24 h-24 rounded-xl bg-purple-600 flex items-center justify-center text-center text-[0.72rem] font-black text-white border border-purple-500">
