      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {variedades.map((v) => {
          ...
          return (
            ...
            >
              <div className="h-full w-full rounded-2xl overflow-hidden bg-[#121215] border border-[#27272a] group-hover:border-purple-500 group-hover:bg-[#18181b] transition-colors duration-200 flex flex-col p-4">
                <div className="w-full h-48 rounded-xl overflow-hidden relative mb-3 bg-black">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="absolute top-2.5 right-2.5 bg-[#121215] border border-[#27272a] text-purple-400 text-[0.72rem] font-semibold px-2.5 py-1 rounded-md">
                    ✨ Manto Sedoso Lh
                  </span>
                </div>

                <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors m-0 mb-1">
                  {v.nombreCorto}
                </h3>

                <span className="text-sm font-extrabold text-purple-400 mb-2 block">
                ...
                <div className="flex flex-wrap gap-1.5 mt-auto pt-3 border-t border-[#27272a]">
                  <span className="text-[0.7rem] bg-[#1f1032] text-purple-400 border border-[#3b1964] px-2 py-0.5 rounded-md font-medium">
                    ✨ Manto Sedoso Lh
                  </span>
                  <span className="text-[0.7rem] bg-[#1f1032] text-purple-400 border border-[#3b1964] px-2 py-0.5 rounded-md font-medium">
                    🧬 Gen {genTag}
